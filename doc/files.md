...
* yukkoin.conf: contains configuration settings for yukkoind or yukkoin-qt
* yukkoind.pid: stores the process id of yukkoind while running
...
* debug.log: contains debug information and general logging generated by yukkoind or yukkoin-qt
