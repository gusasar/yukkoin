...
const char * const BITCOIN_CONF_FILENAME = "yukkoin.conf";
const char * const BITCOIN_PID_FILENAME = "yukkoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Yukkoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Yukkoin";
#else
    // Unix
    return pathRet / ".yukkoin";
#endif
#endif
}
