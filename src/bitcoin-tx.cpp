...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s yukkoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  yukkoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded yukkoin transaction") + "\n" +
              "  yukkoin-tx [options] -create [commands]   " + _("Create hex-encoded yukkoin transaction") + "\n" +
              "\n";
