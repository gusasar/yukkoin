...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.yukkoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.yukkointools.com");
        vSeeds.emplace_back("dnsseed.yukkoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.yukkointools.com");
        vSeeds.emplace_back("seed-b.yukkoin.loshan.co.uk");
