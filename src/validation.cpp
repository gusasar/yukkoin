...
#if defined(NDEBUG)
# error "Yukkoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Yukkoin Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s YUK additional fees, %d delta bytes\n",
